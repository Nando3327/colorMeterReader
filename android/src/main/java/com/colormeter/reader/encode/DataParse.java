...
//    }
    ...
    public static StandardSampleDataBean.StandardDataBean parseGetStandardForNum(byte[] bytes) {
        ...
        standardDataBean.setStartWava((short) (bytes[10] * 10));
        standardDataBean.setWavaLength(bytes[11]);
        standardDataBean.setWavaCount(bytes[12]);
    ...
    public static StandardSampleDataBean.SampleDataBean parseGetNumSampleDataForNumStandard(byte[] bytes) {
        ...
        sampleDataBean.setStartWava((short) (bytes[12] * 10));
        sampleDataBean.setWavaLength(bytes[13]);
        sampleDataBean.setWavaCount(bytes[14]);
