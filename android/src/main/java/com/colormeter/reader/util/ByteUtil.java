...
public class ByteUtil {
    public static final int TYPE_LOW_FIRST = 0x01;// 低位在前
    public static final int TYPE_HIGHT_FIRST = 0x02;// 高位在前
    ...
    public static byte getHight4Bit(byte b) {
        b = (byte) (b & (0b11110000));
        return b;
    }
